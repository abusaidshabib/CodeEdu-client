            ...
            <div className="px-4 py-5 my-5 text-center">
                    ...
                    <div className="col-lg-6 mx-auto">
                        ...
                        <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                <Link type="button" className="btn btn-primary btn-lg px-4 gap-3">LOG IN</Link>
                                <Link type='button' className="btn btn-outline-secondary btn-lg px-4">REGISTER</Link>
